...
In this new major release support the MongoDB-specific embedding relationships (EmbedsMany and EmbedsOne) has been removed. See explanation [here](https://github.com/jenssegers/laravel-mongodb/issues/1974#issuecomment-592859508)
